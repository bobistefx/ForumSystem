...
namespace AutomotiveForumSystem.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "IsBlocked", "IsDeleted", "LastName", "Password", "PhoneNumber", "RoleID", "UserName" },
                values: new object[,]
                {
                    { 1, "john@mail.com", "John", false, false, "Smith", "1234", "0888 102 030", 1, "admin" },
                    { 2, "steven@mail.com", "Steven", false, false, "Solberg", "1020", null, 2, "user" },
                    { 3, "ivan@mail.com", "Ivan", false, false, "Ivanov", "3344", null, 2, "user" }
                });
